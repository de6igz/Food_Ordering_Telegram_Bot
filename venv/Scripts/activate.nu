...
let virtual-env = "D:\Учёба\Учёба\ИТМО\1-й курс\Программирование\Проект_2_сем\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "D:\Учёба\Учёба\ИТМО\1-й курс\Программирование\Проект_2_сем\venv\Scripts\deactivate.nu"
